...
# Unit tests for TopologicalInventoryIngressApiClient::ServicePlanAllOf
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'ServicePlanAllOf' do
  before do
    # run before each test
    @instance = TopologicalInventoryIngressApiClient::ServicePlanAllOf.new
  end
  ...
  describe 'test an instance of ServicePlanAllOf' do
    it 'should create an instance of ServicePlanAllOf' do
      expect(@instance).to be_instance_of(TopologicalInventoryIngressApiClient::ServicePlanAllOf)
    end
  end
