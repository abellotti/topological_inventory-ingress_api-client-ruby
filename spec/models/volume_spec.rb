...
# Unit tests for TopologicalInventoryIngressApiClient::Volume
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'Volume' do
  before do
    # run before each test
    @instance = TopologicalInventoryIngressApiClient::Volume.new
  end
  ...
  describe 'test an instance of Volume' do
    it 'should create an instance of Volume' do
      expect(@instance).to be_instance_of(TopologicalInventoryIngressApiClient::Volume)
    end
  end
