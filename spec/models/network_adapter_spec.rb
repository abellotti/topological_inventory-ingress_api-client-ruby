...
# Unit tests for TopologicalInventoryIngressApiClient::NetworkAdapter
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'NetworkAdapter' do
  before do
    # run before each test
    @instance = TopologicalInventoryIngressApiClient::NetworkAdapter.new
  end
  ...
  describe 'test an instance of NetworkAdapter' do
    it 'should create an instance of NetworkAdapter' do
      expect(@instance).to be_instance_of(TopologicalInventoryIngressApiClient::NetworkAdapter)
    end
  end
