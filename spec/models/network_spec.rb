...
# Unit tests for TopologicalInventoryIngressApiClient::Network
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'Network' do
  before do
    # run before each test
    @instance = TopologicalInventoryIngressApiClient::Network.new
  end
  ...
  describe 'test an instance of Network' do
    it 'should create an instance of Network' do
      expect(@instance).to be_instance_of(TopologicalInventoryIngressApiClient::Network)
    end
  end
