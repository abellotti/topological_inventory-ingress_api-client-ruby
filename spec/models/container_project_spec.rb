...
# Unit tests for TopologicalInventoryIngressApiClient::ContainerProject
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'ContainerProject' do
  before do
    # run before each test
    @instance = TopologicalInventoryIngressApiClient::ContainerProject.new
  end
  ...
  describe 'test an instance of ContainerProject' do
    it 'should create an instance of ContainerProject' do
      expect(@instance).to be_instance_of(TopologicalInventoryIngressApiClient::ContainerProject)
    end
  end
