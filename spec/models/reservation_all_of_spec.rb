...
# Unit tests for TopologicalInventoryIngressApiClient::ReservationAllOf
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'ReservationAllOf' do
  before do
    # run before each test
    @instance = TopologicalInventoryIngressApiClient::ReservationAllOf.new
  end
  ...
  describe 'test an instance of ReservationAllOf' do
    it 'should create an instance of ReservationAllOf' do
      expect(@instance).to be_instance_of(TopologicalInventoryIngressApiClient::ReservationAllOf)
    end
  end
