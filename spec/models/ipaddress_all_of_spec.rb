...
# Unit tests for TopologicalInventoryIngressApiClient::IpaddressAllOf
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'IpaddressAllOf' do
  before do
    # run before each test
    @instance = TopologicalInventoryIngressApiClient::IpaddressAllOf.new
  end
  ...
  describe 'test an instance of IpaddressAllOf' do
    it 'should create an instance of IpaddressAllOf' do
      expect(@instance).to be_instance_of(TopologicalInventoryIngressApiClient::IpaddressAllOf)
    end
  end
