...
# Unit tests for TopologicalInventoryIngressApiClient::ServicePlan
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'ServicePlan' do
  before do
    # run before each test
    @instance = TopologicalInventoryIngressApiClient::ServicePlan.new
  end
  ...
  describe 'test an instance of ServicePlan' do
    it 'should create an instance of ServicePlan' do
      expect(@instance).to be_instance_of(TopologicalInventoryIngressApiClient::ServicePlan)
    end
  end
