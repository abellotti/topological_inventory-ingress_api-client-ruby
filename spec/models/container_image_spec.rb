...
# Unit tests for TopologicalInventoryIngressApiClient::ContainerImage
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'ContainerImage' do
  before do
    # run before each test
    @instance = TopologicalInventoryIngressApiClient::ContainerImage.new
  end
  ...
  describe 'test an instance of ContainerImage' do
    it 'should create an instance of ContainerImage' do
      expect(@instance).to be_instance_of(TopologicalInventoryIngressApiClient::ContainerImage)
    end
  end
