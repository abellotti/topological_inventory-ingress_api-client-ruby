...
# Unit tests for TopologicalInventoryIngressApiClient::SubnetAllOf
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'SubnetAllOf' do
  before do
    # run before each test
    @instance = TopologicalInventoryIngressApiClient::SubnetAllOf.new
  end
  ...
  describe 'test an instance of SubnetAllOf' do
    it 'should create an instance of SubnetAllOf' do
      expect(@instance).to be_instance_of(TopologicalInventoryIngressApiClient::SubnetAllOf)
    end
  end
