...
# Unit tests for TopologicalInventoryIngressApiClient::VmAllOf
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'VmAllOf' do
  before do
    # run before each test
    @instance = TopologicalInventoryIngressApiClient::VmAllOf.new
  end
  ...
  describe 'test an instance of VmAllOf' do
    it 'should create an instance of VmAllOf' do
      expect(@instance).to be_instance_of(TopologicalInventoryIngressApiClient::VmAllOf)
    end
  end
