...
# Unit tests for TopologicalInventoryIngressApiClient::ContainerNode
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'ContainerNode' do
  before do
    # run before each test
    @instance = TopologicalInventoryIngressApiClient::ContainerNode.new
  end
  ...
  describe 'test an instance of ContainerNode' do
    it 'should create an instance of ContainerNode' do
      expect(@instance).to be_instance_of(TopologicalInventoryIngressApiClient::ContainerNode)
    end
  end
