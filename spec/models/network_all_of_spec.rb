...
# Unit tests for TopologicalInventoryIngressApiClient::NetworkAllOf
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'NetworkAllOf' do
  before do
    # run before each test
    @instance = TopologicalInventoryIngressApiClient::NetworkAllOf.new
  end
  ...
  describe 'test an instance of NetworkAllOf' do
    it 'should create an instance of NetworkAllOf' do
      expect(@instance).to be_instance_of(TopologicalInventoryIngressApiClient::NetworkAllOf)
    end
  end
