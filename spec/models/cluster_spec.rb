...
# Unit tests for TopologicalInventoryIngressApiClient::Cluster
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'Cluster' do
  before do
    # run before each test
    @instance = TopologicalInventoryIngressApiClient::Cluster.new
  end
  ...
  describe 'test an instance of Cluster' do
    it 'should create an instance of Cluster' do
      expect(@instance).to be_instance_of(TopologicalInventoryIngressApiClient::Cluster)
    end
  end
