...
# Unit tests for TopologicalInventoryIngressApiClient::HostAllOf
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'HostAllOf' do
  before do
    # run before each test
    @instance = TopologicalInventoryIngressApiClient::HostAllOf.new
  end
  ...
  describe 'test an instance of HostAllOf' do
    it 'should create an instance of HostAllOf' do
      expect(@instance).to be_instance_of(TopologicalInventoryIngressApiClient::HostAllOf)
    end
  end
