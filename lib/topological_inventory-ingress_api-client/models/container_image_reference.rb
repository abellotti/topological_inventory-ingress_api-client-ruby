...
module TopologicalInventoryIngressApiClient
  class ContainerImageReference
    ...
    def list_invalid_properties
      ...
      if @inventory_collection_name !~ Regexp.new(/^container_images$/)
        invalid_properties.push('invalid value for "inventory_collection_name", must conform to the pattern /^container_images$/.')
      end
    ...
    def inventory_collection_name=(inventory_collection_name)
      ...
      if inventory_collection_name !~ Regexp.new(/^container_images$/)
        fail ArgumentError, 'invalid value for "inventory_collection_name", must conform to the pattern /^container_images$/.'
      end
