...
module TopologicalInventoryIngressApiClient
  class OrchestrationStackReference
    ...
    def list_invalid_properties
      ...
      if @inventory_collection_name !~ Regexp.new(/^orchestration_stacks$/)
        invalid_properties.push('invalid value for "inventory_collection_name", must conform to the pattern /^orchestration_stacks$/.')
      end
    ...
    def inventory_collection_name=(inventory_collection_name)
      ...
      if inventory_collection_name !~ Regexp.new(/^orchestration_stacks$/)
        fail ArgumentError, 'invalid value for "inventory_collection_name", must conform to the pattern /^orchestration_stacks$/.'
      end
