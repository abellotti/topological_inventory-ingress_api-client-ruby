...
module TopologicalInventoryIngressApiClient
  class TagReference
    ...
    def list_invalid_properties
      ...
      if @inventory_collection_name !~ Regexp.new(/^tags$/)
        invalid_properties.push('invalid value for "inventory_collection_name", must conform to the pattern /^tags$/.')
      end
    ...
    def inventory_collection_name=(inventory_collection_name)
      ...
      if inventory_collection_name !~ Regexp.new(/^tags$/)
        fail ArgumentError, 'invalid value for "inventory_collection_name", must conform to the pattern /^tags$/.'
      end
