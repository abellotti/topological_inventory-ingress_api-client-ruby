...
module TopologicalInventoryIngressApiClient
  class SubnetReference
    ...
    def list_invalid_properties
      ...
      if @inventory_collection_name !~ Regexp.new(/^subnets$/)
        invalid_properties.push('invalid value for "inventory_collection_name", must conform to the pattern /^subnets$/.')
      end
    ...
    def inventory_collection_name=(inventory_collection_name)
      ...
      if inventory_collection_name !~ Regexp.new(/^subnets$/)
        fail ArgumentError, 'invalid value for "inventory_collection_name", must conform to the pattern /^subnets$/.'
      end
