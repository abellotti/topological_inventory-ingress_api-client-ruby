...
module TopologicalInventoryIngressApiClient
  class NetworkReference
    ...
    def list_invalid_properties
      ...
      if @inventory_collection_name !~ Regexp.new(/^networks$/)
        invalid_properties.push('invalid value for "inventory_collection_name", must conform to the pattern /^networks$/.')
      end
    ...
    def inventory_collection_name=(inventory_collection_name)
      ...
      if inventory_collection_name !~ Regexp.new(/^networks$/)
        fail ArgumentError, 'invalid value for "inventory_collection_name", must conform to the pattern /^networks$/.'
      end
