...
module TopologicalInventoryIngressApiClient
  class HostReference
    ...
    def list_invalid_properties
      ...
      if @inventory_collection_name !~ Regexp.new(/^hosts$/)
        invalid_properties.push('invalid value for "inventory_collection_name", must conform to the pattern /^hosts$/.')
      end
    ...
    def inventory_collection_name=(inventory_collection_name)
      ...
      if inventory_collection_name !~ Regexp.new(/^hosts$/)
        fail ArgumentError, 'invalid value for "inventory_collection_name", must conform to the pattern /^hosts$/.'
      end
