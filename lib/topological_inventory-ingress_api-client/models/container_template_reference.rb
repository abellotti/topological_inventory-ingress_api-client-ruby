...
module TopologicalInventoryIngressApiClient
  class ContainerTemplateReference
    ...
    def list_invalid_properties
      ...
      if @inventory_collection_name !~ Regexp.new(/^container_templates$/)
        invalid_properties.push('invalid value for "inventory_collection_name", must conform to the pattern /^container_templates$/.')
      end
    ...
    def inventory_collection_name=(inventory_collection_name)
      ...
      if inventory_collection_name !~ Regexp.new(/^container_templates$/)
        fail ArgumentError, 'invalid value for "inventory_collection_name", must conform to the pattern /^container_templates$/.'
      end
