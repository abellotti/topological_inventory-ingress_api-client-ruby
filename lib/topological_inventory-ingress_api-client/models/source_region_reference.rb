...
module TopologicalInventoryIngressApiClient
  class SourceRegionReference
    ...
    def list_invalid_properties
      ...
      if @inventory_collection_name !~ Regexp.new(/^source_regions$/)
        invalid_properties.push('invalid value for "inventory_collection_name", must conform to the pattern /^source_regions$/.')
      end
    ...
    def inventory_collection_name=(inventory_collection_name)
      ...
      if inventory_collection_name !~ Regexp.new(/^source_regions$/)
        fail ArgumentError, 'invalid value for "inventory_collection_name", must conform to the pattern /^source_regions$/.'
      end
