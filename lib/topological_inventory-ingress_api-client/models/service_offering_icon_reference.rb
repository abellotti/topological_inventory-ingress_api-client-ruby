...
module TopologicalInventoryIngressApiClient
  class ServiceOfferingIconReference
    ...
    def list_invalid_properties
      ...
      if @inventory_collection_name !~ Regexp.new(/^service_offering_icons$/)
        invalid_properties.push('invalid value for "inventory_collection_name", must conform to the pattern /^service_offering_icons$/.')
      end
    ...
    def inventory_collection_name=(inventory_collection_name)
      ...
      if inventory_collection_name !~ Regexp.new(/^service_offering_icons$/)
        fail ArgumentError, 'invalid value for "inventory_collection_name", must conform to the pattern /^service_offering_icons$/.'
      end
