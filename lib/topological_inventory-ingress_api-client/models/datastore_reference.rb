...
module TopologicalInventoryIngressApiClient
  class DatastoreReference
    ...
    def list_invalid_properties
      ...
      if @inventory_collection_name !~ Regexp.new(/^datastores$/)
        invalid_properties.push('invalid value for "inventory_collection_name", must conform to the pattern /^datastores$/.')
      end
    ...
    def inventory_collection_name=(inventory_collection_name)
      ...
      if inventory_collection_name !~ Regexp.new(/^datastores$/)
        fail ArgumentError, 'invalid value for "inventory_collection_name", must conform to the pattern /^datastores$/.'
      end
