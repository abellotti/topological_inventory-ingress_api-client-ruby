...
module TopologicalInventoryIngressApiClient
  class ReservationReference
    ...
    def list_invalid_properties
      ...
      if @inventory_collection_name !~ Regexp.new(/^reservations$/)
        invalid_properties.push('invalid value for "inventory_collection_name", must conform to the pattern /^reservations$/.')
      end
    ...
    def inventory_collection_name=(inventory_collection_name)
      ...
      if inventory_collection_name !~ Regexp.new(/^reservations$/)
        fail ArgumentError, 'invalid value for "inventory_collection_name", must conform to the pattern /^reservations$/.'
      end
