...
module TopologicalInventoryIngressApiClient
  class ServicePlanReference
    ...
    def list_invalid_properties
      ...
      if @inventory_collection_name !~ Regexp.new(/^service_plans$/)
        invalid_properties.push('invalid value for "inventory_collection_name", must conform to the pattern /^service_plans$/.')
      end
    ...
    def inventory_collection_name=(inventory_collection_name)
      ...
      if inventory_collection_name !~ Regexp.new(/^service_plans$/)
        fail ArgumentError, 'invalid value for "inventory_collection_name", must conform to the pattern /^service_plans$/.'
      end
