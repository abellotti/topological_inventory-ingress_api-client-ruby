...
module TopologicalInventoryIngressApiClient
  class SubscriptionReference
    ...
    def list_invalid_properties
      ...
      if @inventory_collection_name !~ Regexp.new(/^subscriptions$/)
        invalid_properties.push('invalid value for "inventory_collection_name", must conform to the pattern /^subscriptions$/.')
      end
    ...
    def inventory_collection_name=(inventory_collection_name)
      ...
      if inventory_collection_name !~ Regexp.new(/^subscriptions$/)
        fail ArgumentError, 'invalid value for "inventory_collection_name", must conform to the pattern /^subscriptions$/.'
      end
