...
module TopologicalInventoryIngressApiClient
  class ContainerProjectReferenceByName
    ...
    def self.openapi_types
      {
        ...
        :'reference' => :'ContainerNodeReferenceByNameReference',
        :'ref' => :'String'
      }
    end
    ...
    def list_invalid_properties
      ...
      if @inventory_collection_name !~ Regexp.new(/^container_projects$/)
        invalid_properties.push('invalid value for "inventory_collection_name", must conform to the pattern /^container_projects$/.')
      end
      ...
      if @ref !~ Regexp.new(/^by_name$/)
        invalid_properties.push('invalid value for "ref", must conform to the pattern /^by_name$/.')
      end
    ...
    def valid?
      ...
      return false if @inventory_collection_name !~ Regexp.new(/^container_projects$/)
      return false if @reference.nil?
      return false if @ref.nil?
      return false if @ref !~ Regexp.new(/^by_name$/)
      true
    end
    ...
    def inventory_collection_name=(inventory_collection_name)
      ...
      if inventory_collection_name !~ Regexp.new(/^container_projects$/)
        fail ArgumentError, 'invalid value for "inventory_collection_name", must conform to the pattern /^container_projects$/.'
      end
    ...
    def ref=(ref)
      ...
      if ref !~ Regexp.new(/^by_name$/)
        fail ArgumentError, 'invalid value for "ref", must conform to the pattern /^by_name$/.'
      end
