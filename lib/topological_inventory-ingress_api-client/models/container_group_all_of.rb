  ...
  class ContainerGroupAllOf
    ...
    def self.openapi_types
      {
        ...
        :'container_node' => :'AnyOfContainerNodeReferenceContainerNodeReferenceByName',
        :'container_project' => :'AnyOfContainerProjectReferenceContainerProjectReferenceByName',
        :'ipaddress' => :'String',
        :'name' => :'String',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `TopologicalInventoryIngressApiClient::ContainerGroupAllOf` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `TopologicalInventoryIngressApiClient::ContainerGroupAllOf`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'container_project')
    ...
    def hash
      [archived_at, container_node, container_project, ipaddress, name, resource_timestamp, resource_version, source_created_at, source_deleted_at, source_ref].hash
    end
