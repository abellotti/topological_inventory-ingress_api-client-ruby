...
module TopologicalInventoryIngressApiClient
  class ServiceInstanceReference
    ...
    def list_invalid_properties
      ...
      if @inventory_collection_name !~ Regexp.new(/^service_instances$/)
        invalid_properties.push('invalid value for "inventory_collection_name", must conform to the pattern /^service_instances$/.')
      end
    ...
    def inventory_collection_name=(inventory_collection_name)
      ...
      if inventory_collection_name !~ Regexp.new(/^service_instances$/)
        fail ArgumentError, 'invalid value for "inventory_collection_name", must conform to the pattern /^service_instances$/.'
      end
