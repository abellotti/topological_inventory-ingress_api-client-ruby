...
module TopologicalInventoryIngressApiClient
  class ContainerNodeReferenceByName
    ...
    def list_invalid_properties
      ...
      if @inventory_collection_name !~ Regexp.new(/^container_nodes$/)
        invalid_properties.push('invalid value for "inventory_collection_name", must conform to the pattern /^container_nodes$/.')
      end
    ...
    def valid?
      ...
      return false if @inventory_collection_name !~ Regexp.new(/^container_nodes$/)
    ...
    def inventory_collection_name=(inventory_collection_name)
      ...
      if inventory_collection_name !~ Regexp.new(/^container_nodes$/)
        fail ArgumentError, 'invalid value for "inventory_collection_name", must conform to the pattern /^container_nodes$/.'
      end
