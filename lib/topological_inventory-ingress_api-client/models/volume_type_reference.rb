...
module TopologicalInventoryIngressApiClient
  class VolumeTypeReference
    ...
    def list_invalid_properties
      ...
      if @inventory_collection_name !~ Regexp.new(/^volume_types$/)
        invalid_properties.push('invalid value for "inventory_collection_name", must conform to the pattern /^volume_types$/.')
      end
    ...
    def inventory_collection_name=(inventory_collection_name)
      ...
      if inventory_collection_name !~ Regexp.new(/^volume_types$/)
        fail ArgumentError, 'invalid value for "inventory_collection_name", must conform to the pattern /^volume_types$/.'
      end
