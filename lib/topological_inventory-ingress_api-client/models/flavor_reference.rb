...
module TopologicalInventoryIngressApiClient
  class FlavorReference
    ...
    def list_invalid_properties
      ...
      if @inventory_collection_name !~ Regexp.new(/^flavors$/)
        invalid_properties.push('invalid value for "inventory_collection_name", must conform to the pattern /^flavors$/.')
      end
    ...
    def inventory_collection_name=(inventory_collection_name)
      ...
      if inventory_collection_name !~ Regexp.new(/^flavors$/)
        fail ArgumentError, 'invalid value for "inventory_collection_name", must conform to the pattern /^flavors$/.'
      end
