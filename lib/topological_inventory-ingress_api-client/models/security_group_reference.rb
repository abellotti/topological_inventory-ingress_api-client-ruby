...
module TopologicalInventoryIngressApiClient
  class SecurityGroupReference
    ...
    def list_invalid_properties
      ...
      if @inventory_collection_name !~ Regexp.new(/^security_groups$/)
        invalid_properties.push('invalid value for "inventory_collection_name", must conform to the pattern /^security_groups$/.')
      end
    ...
    def inventory_collection_name=(inventory_collection_name)
      ...
      if inventory_collection_name !~ Regexp.new(/^security_groups$/)
        fail ArgumentError, 'invalid value for "inventory_collection_name", must conform to the pattern /^security_groups$/.'
      end
