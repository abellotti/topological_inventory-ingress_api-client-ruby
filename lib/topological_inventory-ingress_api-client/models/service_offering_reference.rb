...
module TopologicalInventoryIngressApiClient
  class ServiceOfferingReference
    ...
    def list_invalid_properties
      ...
      if @inventory_collection_name !~ Regexp.new(/^service_offerings$/)
        invalid_properties.push('invalid value for "inventory_collection_name", must conform to the pattern /^service_offerings$/.')
      end
    ...
    def inventory_collection_name=(inventory_collection_name)
      ...
      if inventory_collection_name !~ Regexp.new(/^service_offerings$/)
        fail ArgumentError, 'invalid value for "inventory_collection_name", must conform to the pattern /^service_offerings$/.'
      end
