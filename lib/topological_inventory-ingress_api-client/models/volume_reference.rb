...
module TopologicalInventoryIngressApiClient
  class VolumeReference
    ...
    def list_invalid_properties
      ...
      if @inventory_collection_name !~ Regexp.new(/^volumes$/)
        invalid_properties.push('invalid value for "inventory_collection_name", must conform to the pattern /^volumes$/.')
      end
    ...
    def inventory_collection_name=(inventory_collection_name)
      ...
      if inventory_collection_name !~ Regexp.new(/^volumes$/)
        fail ArgumentError, 'invalid value for "inventory_collection_name", must conform to the pattern /^volumes$/.'
      end
