...
module TopologicalInventoryIngressApiClient
  class ClusterReference
    ...
    def list_invalid_properties
      ...
      if @inventory_collection_name !~ Regexp.new(/^clusters$/)
        invalid_properties.push('invalid value for "inventory_collection_name", must conform to the pattern /^clusters$/.')
      end
    ...
    def inventory_collection_name=(inventory_collection_name)
      ...
      if inventory_collection_name !~ Regexp.new(/^clusters$/)
        fail ArgumentError, 'invalid value for "inventory_collection_name", must conform to the pattern /^clusters$/.'
      end
