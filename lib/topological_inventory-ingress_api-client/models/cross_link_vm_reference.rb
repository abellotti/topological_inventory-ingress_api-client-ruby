...
module TopologicalInventoryIngressApiClient
  class CrossLinkVmReference
    ...
    def list_invalid_properties
      ...
      if @inventory_collection_name !~ Regexp.new(/^cross_link_vms$/)
        invalid_properties.push('invalid value for "inventory_collection_name", must conform to the pattern /^cross_link_vms$/.')
      end
    ...
    def inventory_collection_name=(inventory_collection_name)
      ...
      if inventory_collection_name !~ Regexp.new(/^cross_link_vms$/)
        fail ArgumentError, 'invalid value for "inventory_collection_name", must conform to the pattern /^cross_link_vms$/.'
      end
