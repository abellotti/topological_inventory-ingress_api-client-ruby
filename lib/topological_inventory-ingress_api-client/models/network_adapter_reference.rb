...
module TopologicalInventoryIngressApiClient
  class NetworkAdapterReference
    ...
    def list_invalid_properties
      ...
      if @inventory_collection_name !~ Regexp.new(/^network_adapters$/)
        invalid_properties.push('invalid value for "inventory_collection_name", must conform to the pattern /^network_adapters$/.')
      end
    ...
    def inventory_collection_name=(inventory_collection_name)
      ...
      if inventory_collection_name !~ Regexp.new(/^network_adapters$/)
        fail ArgumentError, 'invalid value for "inventory_collection_name", must conform to the pattern /^network_adapters$/.'
      end
